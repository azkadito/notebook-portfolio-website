...
# Select a dataset to explore by clicking on its name`,
    output: (
      <div className="dataset-list">
        <h3 className="text-xl font-mono mb-4 text-green-500">Available datasets:</h3>
            ...
            <li key={datasetKey} className="flex items-start">
              ...
              <div>
                <button
                  ...
                  className="px-2 py-0.5 rounded bg-green-800 bg-opacity-70 text-green-400 
                            cursor-pointer transition-all duration-300 border-2 border-green-500 
  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-mono font-bold mb-6 text-green-500">
